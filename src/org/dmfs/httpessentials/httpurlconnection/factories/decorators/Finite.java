...
public final class Finite implements HttpUrlConnectionFactory
{
	...
	/**
	 * An {@link HttpUrlConnectionFactory} decorator that sets connection timeout and socket (read) timeout on the connections returned by the decorated
	 * {@link HttpUrlConnectionFactory}.
	 * 
	 * @param decorated
	 *            Another {@link HttpUrlConnectionFactory}.
	 * @param connectionTimeout
	 *            The connection timeout in milliseconds. A value {@code <0} will preserve the current setting, a value of {@code 0} will set an infinite
	 *            timeout.
	 * @param socketTimeout
